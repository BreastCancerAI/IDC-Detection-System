...
caffe_path = '/glob/intel-python/versions/2018u2/intelpython3/pkgs/caffe-1.1.0-py36_intel_0/bin/c/'
...
command = '/glob/deep-learning/versions/py-faster-rcnn/caffe-fast-rcnn/tools/extra/parse_log.sh ' + model_log_path
